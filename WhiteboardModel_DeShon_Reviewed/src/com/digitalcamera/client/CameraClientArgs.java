...
/**
 * JR: works as intended, and usage banner is good.
 *
 * For the 'note' string, you've hardcoded labels HD, FULL_HD, etc., and I understand why.
 * This is because Resolution has overridden toString() to return "720p", etc.
 * For future reference, every enum has a (final) method named name(), which returns the instance name.
 * I've shown you how to leverage that below, check it out.
 */
